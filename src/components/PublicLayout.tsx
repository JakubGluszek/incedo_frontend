...
const PublicLayout: React.FC<Props> = ({ children }) => {
  ...
  const header = (
    <header className={`transition-height duration-300 w-screen ${scrollTop > 0 ? 'h-16' : 'h-20'} fixed top-0 bg-slate-50 dark:bg-[#242933] ${scrollTop > 0 ? 'shadow-md shadow-slate-200/50 dark:shadow-black/10' : ''}`}>
